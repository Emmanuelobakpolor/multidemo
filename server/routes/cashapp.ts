...
export const handleCreateAdmin: RequestHandler = async (req, res) => {
  ...
  try {
    const userResponse = await fetch(`${DJANGO_API_BASE}/CashApp/register-admin`, {
      method: "POST",
      headers: {
...
export const handleCreateUser: RequestHandler = async (req, res) => {
  ...
  try {
    // Call CashApp-specific register endpoint which properly handles password hashing and platform association
    const userResponse = await fetch(`${DJANGO_API_BASE}/CashApp/register`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export const handleLogin: RequestHandler = async (req, res) => {
  ...
  try {
    ...
    // Get user account for CashApp platform
    ...
    if (accounts.length === 0) {
      const response: ApiResponse = {
        success: false,
        error: "CashApp account not found",
      };
      return res.status(404).json(response);
    }
...
// Search for CashApp users (by email, username, or mobile number)
export const handleSearchUsers: RequestHandler = async (req, res) => {
  const { query } = req.query;

  try {
    // Search for users on CashApp platform (Platform ID 5)
    const usersResponse = await fetch(
      `${DJANGO_API_BASE}/CashApp/search?query=${query}`
    );
...
export const handleSendMoney: RequestHandler = async (req, res) => {
  ...
  try {
    ...
    // Get sender account (CashApp platform)
    ...
    // Get recipient account (CashApp platform)
...
export const handleGetChatStatus: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/CashApp/chat/status/${email}`);
...
export const handleGetUnreadCount: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/CashApp/chat/unread/${email}`);
    const data = await response.json();
...
export const handleGetChatHistory: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/CashApp/chat/history/${email}`);
    const data = await response.json();
...
export const handleSendMessage: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/CashApp/chat/send`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export const handleMarkMessagesAsRead: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/CashApp/chat/mark-read/${email}`, {
      method: "POST",
    });
    const data = await response.json();
...
export const handleToggleChat: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/CashApp/admin/user/${userId}/toggle-chat`, {
      method: "POST",
    });
...
// Get all CashApp users (admin)
export const handleGetAllUsers: RequestHandler = async (req, res) => {
  try {
    const response = await fetch(`${DJANGO_API_BASE}/CashApp/admin/users`);
    const data = await response.json();
...
export const handleFundWallet: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/CashApp/admin/fund-wallet`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export const handleEditUser: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/CashApp/admin/edit-user`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
...
export const handleGetAllTransactions: RequestHandler = async (req, res) => {
  try {
    const response = await fetch(`${DJANGO_API_BASE}/CashApp/admin/transactions`);
    const data = await response.json();
