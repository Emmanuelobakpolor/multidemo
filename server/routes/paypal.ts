...
export const handleCreateUser: RequestHandler = async (req, res) => {
  ...
  try {
    // Call PayPal-specific register endpoint which properly handles password hashing and platform association
    const userResponse = await fetch(`${DJANGO_API_BASE}/PayPal/register`, {
      method: "POST",
      headers: {
...
export const handleSendMessage: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/PayPal/chat/send`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export const handleMarkMessagesRead: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/PayPal/chat/mark-read/${email}`, {
      method: "POST",
    });
...
export const handleGetChatHistory: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/PayPal/chat/history/${email}`);
    const data = await response.json();
...
export const handleGetUnreadMessagesCount: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/PayPal/chat/unread/${email}`);
    const data = await response.json();
...
export const handleGetChatStatus: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/PayPal/chat/status/${email}`);
    const data = await response.json();
...
export const handleToggleChat: RequestHandler = async (req, res) => {
  ...
  try {
    const response = await fetch(`${DJANGO_API_BASE}/PayPal/admin/user/${userId}/toggle-chat`, {
      method: "POST",
    });
