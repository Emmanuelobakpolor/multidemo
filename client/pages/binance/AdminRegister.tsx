...
const BinanceAdminRegister = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/binance/register-admin", {
        method: "POST",
        headers: {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 dark:from-slate-950 dark:to-blue-950 flex flex-col items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">Redirecting to Binance admin dashboard...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3.5 rounded-lg border text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#F0B90B] focus:border-[#F0B90B] transition ${
            ...
            <button
              type="submit"
              className="w-full py-3.5 bg-[#F0B90B] text-black font-semibold rounded-lg hover:bg-[#E8A010] transition shadow-md hover:shadow-lg"
            >
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 text-center">
            <p className="text-gray-600 dark:text-gray-400">
              ...
              <Link to="/binance/admin/login" className="text-[#F0B90B] font-medium hover:underline">
                Sign In
              </Link>
            </p>
          </div>
...
export default BinanceAdminRegister;
