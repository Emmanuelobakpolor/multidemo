...
const CryptoPortAdminDashboard = () => {
  ...
  const fetchUnreadCounts = async () => {
    ...
    for (const user of users) {
      try {
        ...
        const historyResponse = await fetch(`https://multi-bakend.onrender.com/api/binance/chat/history/${user.email}`);
  ...
  const handleToggleChat = async (userId: string) => {
    try {
      const response = await fetch(`/api/binance/admin/user/${userId}/toggle-chat`, {
        method: "POST",
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch("/api/binance/admin/users");
  ...
  const handleFundUser = async () => {
    ...
    try {
      const response = await fetch("/api/binance/admin/fund", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
  ...
  const handleUpdateDepositAddress = async () => {
    ...
    try {
      const response = await fetch("/api/binance/admin/user/update-deposit-address", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          userId: selectedUser.id,
  ...
  const handleDeleteUser = async (userId: string) => {
    ...
    try {
      ...
      const response = await fetch(`/api/binance/admin/user/${userId}/delete`, {
        method: "DELETE",
        headers: { "Content-Type": "application/json" },
      });
      const data = await response.json();
