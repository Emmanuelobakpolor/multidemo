...
const SendWaveChatWidget: React.FC<ChatWidgetProps> = ({ user, isOpen, onClose }) => {
    ...
    return (
      <div className="fixed bottom-4 right-4">
        <button
          ...
          className="bg-[#007DFE] text-white p-4 rounded-full shadow-lg hover:bg-blue-700 transition-colors"
        >
      ...
      <div className="p-4 border-t">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#007DFE] bg-gray-50"
            disabled={loading}
          />
          <button
            onClick={sendMessage}
...
export default SendWaveChatWidget;
